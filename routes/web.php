...
Route::resources([
    ...
    'mydirectories' => App\Http\Controllers\MydirectoriesController::class,
...
Route::get('SearchMydirectories', 'App\Http\Controllers\SearchController@searchdirectories')->name('SearchMydirectories');
